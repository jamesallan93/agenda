  ...
  <header class="admin-header">
    ...
    <nav class="mr-auto my-auto">
      <ul class="nav align-items-center">
        ...
        <li class="nav-item" v-if="this.$route.name !== 'Contacts'">
          <router-link class="menu-link" :to="{name:'Contacts'}">
            <i class="mdi mdi-arrow-left mdi-24px align-middle mr-2 ml-3"></i><strong>Voltar</strong>
          </router-link>
        </li>
      </ul>
    </nav>
            ...
            <div class="dropdown-menu notification-container dropdown-menu-right">
              ...
              <div class="notification-events bg-gray-300">
                ...
                <a href="#" class="d-block m-b-10">
                  <div class="card">
                    <div class="card-body">
                      <i class="mdi mdi-cancel text-danger"></i> Your holiday
                      has been denied
                    </div>
                  </div>
                </a>
